...
public class Invigilator extends javax.swing.JFrame {
 DbConnect dbcon = new DbConnect();
    Vector<Integer> invigelator_id = new Vector<Integer>();
    int h_id;
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" INVIGELATOR REGISTRATION");
        ...
        jLabel3.setText("Invigelator's id:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 130, 42));

        jTextField1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 70, 380, 40));
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 140, 380, 40));
        ...
        jLabel5.setText("Invigelator's name:");
...
private void save() {
        ...
        try {
            String query = "insert into invigelator (name,code) values(?,?)";
    ...
    private void fetch() {
        ...
        invigelator_id = new Vector<Integer>();
        model.addColumn("S/N");
        model.addColumn("NAME");
        model.addColumn("ID");
//=+
        try {
            String query = "select id,name,code from invigelator where status=0";
            int id;
            String name;
            String code;
   ...
   int id=invigelator_id.elementAt(i);
        try {
           String query="delete from invigelator where id="+id;
           dbcon.ps=dbcon.con.prepareStatement(query);
          if (dbcon.ps.executeUpdate() == 1) {
    ...
    private void update(){
        ...
        h_id=invigelator_id.elementAt(i);
   ...
   return;
    ...
    private void updateData() {
        ...
        int id=h_id;
        try {
            String query = "update invigelator set name=?,code=? where id="+id;
